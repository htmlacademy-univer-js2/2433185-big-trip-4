import { MODE, BASE_POINT, USER_ACTION } from '../const.js';
import {
  RenderPosition,
  remove,
  render,
} from '../framework/render.js';
import CreatePointButtonView from '../view/new-point-button-view.js';
import PointEditorView from '../view/edit-point-view.js';
...
export default class CreatePointPresenter {
  ...
  #formSubmitHandler = async (point) => {
    ...
    await this.#onUserAction(USER_ACTION.CREATE_POINT, point);
  };
